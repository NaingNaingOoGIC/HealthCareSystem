		...
		<div class="container-fluid h-custom">
			<div
				...
				<div class="col-md-9 col-lg-6 col-xl-5 d-none d-md-flex">
					<img src="/HealthCareSystem/Images/patientLogin.png"
						class="img-fluid" alt="Sample image">
				</div>
				<!--end of left panel -->
				<!-- right login panel -->
				<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
					<div class="card gradient-skyblue text-dark mt-4"
						...
						<div class="card-body p-5 text-center">
							...
							<div class="mb-md-1 mt-md-4 pb-5">
								...
								<p class="text-dark-50 mb-4 d-none d-md-inline-block">Please
									enter your username and password!</p>
								<html:form action="/PatientLogin" styleId="myForm">
							...
							<div class="form-outline form-dark mb-4"
								style="text-align: left;">
								<label class="form-label h6"> Not a Member ? Please </label><span
									class="h6"> <a href="Register.do">Register Here.</a>
								</span>
							</div>
						</div>
					</div>
