	...
	<div
		...
		<div
			...
			<a href="#"
				...
				<span class="fs-5 d-none d-md-inline text-primary">Welcome,<br>${PatientForm.loginPatient.patientName}</span>
			</a>
			<ul
				...
				<li class="nav-item"><a href="PatientHome.do"
					class="nav-link px-sm-0 px-2"><i class="fa-solid fa-house"></i><span
						class="ms-1 d-none d-sm-inline">Home</span></a></li>
				<li class="nav-item"><a href="Progress.do"
					class="nav-link px-sm-0 px-2"><i class="fa-solid fa-list-check"></i><span
						class="ms-1 d-none d-sm-inline">Medical Record</span></a></li>
				<li><a href="Appointment.do" class="nav-link px-sm-0 px-2"><i
						class="fa-solid fa-calendar-check"></i><span
						class="ms-1 d-none d-sm-inline">Appointment</span> </a></li>
				<li><a href="PatientSearchDoctor.do"
					class="nav-link px-sm-0 px-2"><i
						class="fa-solid fa-user-doctor"></i><span
						class="ms-1 d-none d-sm-inline">Search Doctor</span> </a></li>
				<li class="dropdown"><a href="#"
					...
					<ul class="dropdown-menu dropdown-menu-dark text-small shadow"
						...
						<li><a class="dropdown-item" href="PatientProfile.do">Your
								Profile</a></li>
						<li><a class="dropdown-item" href="PatientChangePs.do">Change
								Password</a></li>
						<li>
