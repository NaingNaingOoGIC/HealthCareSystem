 ...
 * @see com.HealthCareSystem.business.entity.Admin
...
public class AdminHome {
	...
	public Admin findById(java.lang.Integer id) {
		...
		try {
			Admin instance = (Admin) sessionFactory.getCurrentSession()
					.get("com.HealthCareSystem.business.entity.Admin", id);
			if (instance == null) {
	...
	public List<Admin> findByExample(Admin instance) {
		...
		try {
			List<Admin> results = (List<Admin>) sessionFactory.getCurrentSession()
					.createCriteria("com.HealthCareSystem.business.entity.Admin").add(create(instance)).list();
